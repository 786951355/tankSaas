...
public class TankerDialog extends Dialog {
    ...
    public TankerDialog(@NonNull Activity context) {
        super(context);

        this.context = new WeakReference<>(context);
    }

    public TankerDialog(@NonNull Activity context, int theme) {
        super(context, theme);
        this.context = new WeakReference<>(context);
    }

    protected TankerDialog(@NonNull Activity context, boolean cancelable,
                           @Nullable OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        this.context = new WeakReference<>(context);
    }

    public TankerDialog(@NonNull Activity context, boolean cancelable, boolean cancelOnTouchOutside) {
        super(context);
        this.context = new WeakReference<>(context);
    ...
    protected void initVisibility() {
        ...
        switch (messageType) {
            ...
            case PHONE_DIALOG:
                ...
                if (!TextUtils.isEmpty(titleText)) {//如果传递了tilte，就显示传递过来的值
                    pd_tv_title.setText(titleText);
                }
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (optionListener != null) {
                    try {
                        optionListener.onConfirm(TankerDialog.this);
                    } catch (Exception e) {
                        Logger.e("confirm: " + e);
                    }
                }
...
//        initDialog();
    ...
    public interface OptionListener {
        void onConfirm(TankerDialog obDialog);
    }
