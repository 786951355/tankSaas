...
public class PhotoPicker {
    ...
    public final static String EXTRA_GROUP_POSITION = "POSITION";
    ...
    public static class PhotoPickerBuilder {
        ...
        public PhotoPickerBuilder setSelected(ArrayList<ImageBean> imagesUri) {
            ArrayList<ImageBean> imageBeans = new ArrayList<>(imagesUri);
            if (imageBeans.size() > 0) {
                imageBeans.remove(0);
            }
            mPickerOptionsBundle.putParcelableArrayList(EXTRA_ORIGINAL_PHOTOS, imageBeans);
            return this;
        }
        ...
        public PhotoPickerBuilder setGroupPosition(int groupPosition) {
            mPickerOptionsBundle.putInt(EXTRA_GROUP_POSITION, groupPosition);
            return this;
        }
    }
}
