...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
    ...
    public PhotoGridAdapter(Context context, RequestManager requestManager, List<PhotoDirectory> photoDirectories, ArrayList<ImageBean> orginalPhotos, int colNum) {
    ...
    public ArrayList<ImageBean> getSelectedPhotoPaths() {
        ArrayList<ImageBean> selectedPhotoPaths = new ArrayList<>(getSelectedItemCount());
