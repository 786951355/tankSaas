 ...
 * 确认报价输出信息
 */
public class ConfirmQuoterModel implements Serializable {

    private String code;
    private String message;
    private String requestUUID;
    private String responseTime;
    private List<ConfirmQuoter> data;
    ...
    public List<ConfirmQuoter> getData() {
        return data;
    }

    public void setData(List<ConfirmQuoter> data) {
        this.data = data;
    }

    public class ConfirmQuoter {
        ...
        public int getSearchVehicleId() {
            return searchVehicleId;
        }

        public void setSearchVehicleId(int searchVehicleId) {
