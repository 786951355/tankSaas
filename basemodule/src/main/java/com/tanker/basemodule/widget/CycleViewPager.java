 ...
 * 实现可循环，可轮播的viewpager
 */
public class CycleViewPager extends Fragment implements ViewPager.OnPageChangeListener, CycleViewPagerHandler.Callback {
    ...
    public void setData(List<View> views, ImageCycleViewListener listener) {
        setData(views, null, listener, 0);
    }

    public void setData(List<View> views, List<Integer> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<View> views, List<Integer> list, ImageCycleViewListener listener, int showPosition) {
