...
import com.tanker.basemodule.adapter.ExpandableGridAdapter;
...
public class ExpandableGridView extends ExpandableListView implements ExpandableListView.OnGroupClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null)
            return;
        typedArray = context.obtainStyledAttributes(attrs, R.styleable.ExpandableGridView);
        isOverwriteOnMeasure = typedArray.getBoolean(R.styleable.ExpandableGridView_overwrite_measure, false);
        isGroupClickable = typedArray.getBoolean(R.styleable.ExpandableGridView_group_clickable, true);
        horizontalSpacing = typedArray.getDimensionPixelOffset(R.styleable.ExpandableGridView_horizontal_spacing, 0);
        verticalSpacing = typedArray.getDimensionPixelOffset(R.styleable.ExpandableGridView_vertical_spacing, 0);
//        typedArray.recycle();
    }
